...
- Code MUST follow [language] style guide
- Functions exceeding 50 lines MUST be justified
- Error conditions MUST be explicitly handled
...
- CLI tools MUST support --help, --verbose, --output flags
- Response time for user actions MUST be <200ms for acknowledgment

**Performance (Principle IV)**:

- API endpoints: p95 <200ms (read), <500ms (write)
